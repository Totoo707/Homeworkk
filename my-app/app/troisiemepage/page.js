      ...
      >
        <main className="flex-grow flex flex-col items-center justify-center px-6 py-16">
          ...
          >
            ...
            <motion.button
              type="submit"
              className="w-full opacity-60 py-3 mt-4 bg-gradient-to-r from-yellow-400 to-pink-500 text-white text-xl font-semibold rounded-xl shadow-lg hover:scale-105 transition-transform"
