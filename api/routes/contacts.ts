...
// ✅ Interface TypeScript pour un message de contact
...
// ✅ Modèle Mongoose
const ContactModel =
  mongoose.models.Contact || model<ContactMessage>('Contact', contactSchema);
...
router.post('/', async (req: Request<{}, {}, Partial<ContactMessage>>, res: Response) => {
